...
export const ABOUT_STATS = [
  ...
  { label: 'Successful Projects', value: 150, icon: Award },
  { label: 'Happy Clients', value: 50, icon: PenTool },
]
...
export const TEAM_TESTIMONIALS = [
  {
    author: 'CEO, Healthcare Brand',
    reason: 'We loved working with MEDesign',
    testimonial: 'MEDesign transformed our brand presence with innovative design and strategic marketing.',
  },
]
